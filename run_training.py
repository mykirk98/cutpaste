...
def parse_args():
    ...
    parser.add_argument('--type', dest='type', default="all",
    ...
    parser.add_argument('--test_epochs', dest='test_epochs', default=10, type=int,
                        help='interval to calculate the auc during trainig, if -1 do not calculate test scores, (default: 10)')
    parser.add_argument('--freeze_resnet', dest='freeze_resnet', default=20, type=int,
    ...
    parser.add_argument('--head_layer', dest='head_layer', default=1, type=int,
